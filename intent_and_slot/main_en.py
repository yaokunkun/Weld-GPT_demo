...
output_dir = config.save_dir_en + '_0528'
...
if __name__ == '__main__':
    ...
    model = AutoModelForTokenClassification.from_pretrained(config.bert_dir_en, num_labels=len(label_list))
    ...
    if config.do_train:
        ...
        raw_examples = Processor.get_examples(config.validate_path_en, 'validate')
