...
possible_param_values = {
    ...
    "MIG": ["CO2", "MAG", "米格", "气保焊", "米格焊", "气体保护焊", "mig", "mig焊接", "二氧化碳气体保护焊"] + ["7保焊", "7宝焊"] + ["mi"],
    ...
    #"SMAW": ["焊条电弧焊"]
    "MMA": ["MMA","手工电弧焊","焊条电弧焊","SMAW","stick welding","手工金属电弧焊","药皮焊条电弧焊", "涂药焊条电弧焊","手把焊","条焊","棒焊","手工焊","传统电弧焊","焊条焊","电弧手工焊","药芯焊条焊","工地焊"],
    "TIG_AC": [ "氩弧焊机交流","氩弧焊交流","TIG_AC","交流TIG","TIG交流","ACTIG","AC-TIG","TIGAC","TIG-AC","GTAWAC","GTAW-AC","交流钨极惰性气体保护焊","交流钨极氩弧焊","交流氩弧焊","铝TIG焊","TIG铝焊","交流GTAW","钨极交流氩弧焊","交流手工钨极氩弧焊","AC-GTAW","ACGTAW","tig welding with ac","alternating current tig","交流非熔化极惰性气体保护焊","交流非熔化极氩弧焊","手工交流TIG焊","铝材专用TIG焊"],
    "TIG_DC": [ "氩弧焊机直流","氩弧焊直流","TIG_DC","直流TIG","TIG直流","DCTIG","DC-TIG","TIGDC","TIG-DC","GTAWDC","GTAW-DC","直流钨极惰性气体保护焊","直流钨极氩弧焊","直流氩弧焊","钢TIG焊","TIG钢焊","直流GTAW","钨极直流氩弧焊","直流手工钨极氩弧焊","DC-GTAW","DCGTAW","tig welding with dc","direct current tig","直流非熔化极惰性气体保护焊","直流非熔化极氩弧焊","手工直流TIG焊","钢材专用TIG焊"],
    "TIG":["氩弧焊","氩弧焊机交流","TIG","钨极惰性气体保护焊","GTAW"]
}
