...
#                                       "encoding": "raw"}}
#                         d = json.dumps(d)
#                         await ws.send(d)  # TODO:用await发送socket请求
...
#                                       "audio": str(base64.b64encode(buf), 'utf-8'),
#                                       "encoding": "raw"}}
#                         await ws.send(json.dumps(d))  # TODO:用await发送socket请求
#                     # 最后一帧处理
...
# os.makedirs(r"D:\\projects\\Weld-GPT_demo\\app\\data", exist_ok=True)
# speech_dir = r"D:\\projects\\Weld-GPT_demo\\app\\data"
...
if __name__ == "__main__":
    output = asyncio.run(speech2text("/dev_data_2/zkyao/code/data/speech/铝九十九点五.pcm"))
    print(output)